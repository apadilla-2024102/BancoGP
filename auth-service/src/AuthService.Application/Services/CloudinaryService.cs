...
public class CloudinaryService(IConfiguration configuration) : ICloudinaryService
{
    ...
    {
        var defaultPath = configuration["clodinarySettings:DefaultAvatarPath"] ?? "bancogp_xjoycv.png";
    ...
    {
        var baseUrl = configuration["clodinarySettings:BaseURL"] ?? "https://res.cloudinary.com/dbjg9o5oj/image/upload/v1771474381";
